export const largeCardSections = [
  {
    id: 1,
    title: 'Top-rated Fire Extinguisher in Thessaloniki/SKG',
    snippet: 'User say these are the best fire extinguishers to rent if your house is burning down.',
    cards: [
      {
        id: 19,
        title: "Thessaloniki's Portable 2L Fire Extinguisher",
...
export const smallCardSections = [
  {
    id: 1,
    title: 'Fire Extinguisher in SKG',
    cards: [
      {
        id: 1,
        image: 'fe7.jpg'
  ...
  {
    id: 2,
    title: 'Fire Extinguisher in Athens',
    cards: [
      {
        id: 13,
        image: 'fe19.jpg'
